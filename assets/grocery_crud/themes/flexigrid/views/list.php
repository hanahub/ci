...
?><div class="bDiv" >
		...
		<thead>
			<tr class='hDiv'>
                <?php if ($this->get_table() == "product") : ?>
                <th width="auto" style="text-align: center;">
                    <input type="checkbox" class="inline_checkbox" id="check_all_products"/>
                </th>
                <?php endif; ?>
...
<?php foreach($list as $num_row => $row){ ?>        
		<tr  <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
            <?php if ($this->get_table() == "product") : ?>
                <th width="auto">
                    <input type="checkbox" class="inline_checkbox product_checkbox" data-id="<?php echo $row->productId; ?>"/>
                </th>
                <?php endif; ?>
			<?php foreach($columns as $column){?>
